...
Q_CONSTINIT static const uint qt_meta_data_CLASSDatabaseManagerENDCLASS[] = {
 ...
 // methods: name, argc, parameters, tag, flags, initial metatype offsets
       ...
       3,    0,   69,    2, 0x02,    2 /* Public */,
       4,    1,   70,    2, 0x02,    3 /* Public */,
       6,    1,   73,    2, 0x02,    5 /* Public */,
       8,    1,   76,    2, 0x02,    7 /* Public */,
      10,    1,   79,    2, 0x02,    9 /* Public */,
      12,    1,   82,    2, 0x02,   11 /* Public */,
      13,    1,   85,    2, 0x02,   13 /* Public */,
      15,    0,   88,    2, 0x02,   15 /* Public */,
...
void DatabaseManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 6: { QVariantList _r = _t->getRandomEpisodes((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])));
            if (_a[0]) *reinterpret_cast< QVariantList*>(_a[0]) = std::move(_r); }  break;
        case 7: { QVariantList _r = _t->searchEpisodes((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])));
            if (_a[0]) *reinterpret_cast< QVariantList*>(_a[0]) = std::move(_r); }  break;
        case 8: _t->resetDatabase(); break;
        default: ;
        }
    }
}
